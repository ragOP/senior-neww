...
import Head_bg from "../assests/card.png";
// import HeaderLogo from "../assets/sawal.png";
import aa from "../assests/logo.png";
...
const handleQuizN = () => {
  ...
  return (
    <div>
     {/* <ToastContainer /> */}
     <div  className="top-sticky-blue-test3" id="top">
      ...
      {step === "process" ? (
        <>
          <div className="main-container-5">
            ...
            <div style={{marginTop:'-5px'}} className="survey1">
