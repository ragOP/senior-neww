      ...
      {step === "process" ? (
          ...
          <div className="main-container-5">
            <div className="main-descrition-5-5">
              <div className="main-des-title-6-7">
                <b>
                  Americans Over 65 Can Now Qualify For The $3300 Food Allowance
                  Card in 2024!
                </b>
              </div>
              <img className="topic-img-middle-z" src={Head_bg} alt="head" />
              <div style={{ marginTop: "14px" }} className="main-des-5">
                Americans over 65 years old can claim the 2024 Food Allowance
                Card that gives them up to $3300. Americans can use the funds to
                fully cover their Food, Medicines, etc. at Walmart and thousands
                of other participating stores!
              </div>
              <div className="main-des-5" style={{ marginTop: "-5px" }}>
                If you have not yet claimed your monthly allowance then answer
                the questions below and once approved{" "}
                <b>
                  you will have your $3,300 Food Allowance mailed to you within
        ...
        <div className="checking">
          ...
          <a href="tel:+18446720874">
            <div className="call-btn">CALL (844) 672-0874</div>
          </a>
